...
public class MainDrawerActivity extends ActionBarActivity {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		/*
		 * switch (item.getItemId()) { case R.id.menu_overflow: return true;
		 * default :
		 * 
		 * }
		 */
...
/*	@Override
	...
	@SuppressLint("InflateParams") private void iniPopupWindow() {
		...
		lvPopupList.setAdapter(new SimpleAdapter(MainDrawerActivity.this,
		...
		lvPopupList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				case 0:
					...
					FragmentTransaction ft0 = getFragmentManager()
							.beginTransaction();
				...
				case 1:
					...
					FragmentTransaction ft1 = getFragmentManager()
							.beginTransaction();
					ft1.replace(R.id.frame_container,
							SimulNaiveBayesIntroFragment);
					// ft.addToBackStack(null);
					ft1.commit();
					mDrawerLayout.closeDrawer(mDrawerList);
					pwMyPopWindow.dismiss();
