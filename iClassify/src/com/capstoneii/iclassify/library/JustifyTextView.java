 ...
 */
public class JustifyTextView extends TextView implements Justify.Justified {

	  @SuppressWarnings("unused")
	  public JustifyTextView(final @NotNull Context context) {
	    super(context);
	    super.setMovementMethod(new LinkMovementMethod());
	  }

	  @SuppressWarnings("unused")
	  public JustifyTextView(final @NotNull Context context, final AttributeSet attrs) {
	    super(context, attrs);
