...
public class VideoMenuActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		videoFile1 = "android.resource://" + getPackageName() + "/" + R.raw.videoidtree;
		
		videoFile2 = "android.resource://" + getPackageName() + "/" + R.raw.videoknn;
            ...
            public void onClick(ExpandableButtonMenu.MenuButton action) {
                switch (action) {
                    ...
                    case LEFT:
                        ...
                        break;
                    case RIGHT:
                        Toast.makeText(VideoMenuActivity.this, "Native Bayes", Toast.LENGTH_SHORT).show();
                        break;
                }
            }
        });
