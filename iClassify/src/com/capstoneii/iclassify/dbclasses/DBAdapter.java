...
public class DBAdapter {
	...
	public static final String[] ALL_USER = new String[] {USER_ID, USER_NAME, USER_FNAME, USER_LNAME, USER_AGE, USER_SEX};
	...
	public static final String[] ALL_JSKEYS = new String[] {_JSID, _CHID, _JSNAME, _JSRETAKE, _JSAVERAGE};
	public static final String JSQUIZ_TABLE_SQL = "CREATE TABLE "+JSQUIZ_TABLE+ "("
			+ _JSID + " INTEGER PRIMARY KEY autoincrement, "
			+ _CHID + " INTEGER not null, "
			+ _JSNAME + " TEXT not null, "
			+ _JSRETAKE + " TEXT not null, "
			+ _JSAVERAGE + " TEXT not null " + ");";
	...
	public static final String JS1_TABLE_SQL = "CREATE TABLE IF NOT EXISTS " + JS1_TABLE + "("
	...
	public static final String JS2_TABLE_SQL = "CREATE TABLE IF NOT EXISTS " + JS2_TABLE + "("
			+ QUE_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, "
			+ QUE_LESSON + " TEXT, "
			+ QUE_ITEM + " TEXT, "
			+ QUE_ANS + " TEXT, "
	...
	public static final String JS3_TABLE_SQL = "CREATE TABLE IF NOT EXISTS " + JS3_TABLE + "("
			+ QUE_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, "
			+ QUE_LESSON + " TEXT, "
			+ QUE_ITEM + " TEXT, "
			+ QUE_ANS + " TEXT, "
	...
	public static final String JS4_TABLE_SQL = "CREATE TABLE IF NOT EXISTS " + JS4_TABLE + "("
			+ QUE_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, "
			+ QUE_LESSON + " TEXT, "
			+ QUE_ITEM + " TEXT, "
			+ QUE_ANS + " TEXT, "
	...
	public static final String JS5_TABLE_SQL = "CREATE TABLE IF NOT EXISTS " + JS5_TABLE + "("
			+ QUE_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, "
			+ QUE_LESSON + " TEXT, "
			+ QUE_ITEM + " TEXT, "
			+ QUE_ANS + " TEXT, "
	...
	// CREATING TEMPORARY STORAGE BY USING SQLITE
		...
		public static final String[] ALL_TEMPS = new String[] { TEMP_ID, TEMP_SET, TEMP_LESSON, TEMP_Q_ITEM, TEMP_ANS, TEMP_UANS};
		public static final String TEMP_TABLE_SQL = "CREATE TABLE IF NOT EXISTS " + TEMP_QUE_TABLE + "("
	...
	// Context of application who uses us.
		...
		*/
		...
		public Cursor getAllrows(){
			Cursor cr = db.query(true, SCORE_TABLE, ALL_KEYS, null, null, null, null, null, null);
			if (cr != null) {
				cr.moveToFirst();
			}
			return cr;
		...
		public Cursor getAllScoreWith(long rid){
			...
			Cursor cr = db.query(true, SCORE_TABLE, ALL_KEYS, where, null, null, null, null, null);
			if (cr != null) {
				cr.moveToFirst();
			}
			return cr;
		...
		public long addjsquiz(int _cid, String _jsname, String _retake, String _jsaverage){
			ContentValues vl = new ContentValues();
			vl.put(_CHID, _cid);
		...
		public Cursor getAllquiz(){
			Cursor cr = db.query(true, JSQUIZ_TABLE, ALL_JSKEYS, null, null, null, null, _JSNAME, null);
			if (cr != null) {
				cr.moveToFirst();
			}
			return cr;
		...
		public Cursor getAllChapterRow(long rowId) {
			...
			Cursor c = 	db.query(true, JSQUIZ_TABLE, ALL_JSKEYS, 
		...
		/*
		//GET ALL THE SCORES WITH RETAKE AND _NAME
		public Cursor getAllScorewith(long ccid, String _name){
			Cursor cr = db.rawQuery("SELECT * FROM " +SCORE_TABLE+ " WHERE rid=? AND ccid=?", new String[]{Long.toString(ccid), _name});
			if(cr != null){
				cr.moveToFirst();
			}
			return cr;
		...
		*/
		...
		public Cursor getAllscorewithChapter(String _name){
			...
			Cursor cr = db.rawQuery("SELECT * FROM " +SCORE_TABLE+ " WHERE " +_NAME+ "=?", new String[]{_name});
			if(cr != null){
				cr.moveToFirst();
			}
		...
		public void deletescorerowSet(long ccid, String _name){
			db.delete(SCORE_TABLE, "ccid=? AND score_name=?", new String[]{Long.toString(ccid), _name});
		}
		...
		public long addUser(String uname, String fname, String lname, String uage, String sex){
		...
		public Cursor getAllUsers(){
			Cursor cr = db.query(true, USER_TABLE, ALL_USER, null, null, null, null, null, null);
			if (cr != null) {
				cr.moveToFirst();
			}
			return cr;
		...
		public boolean Login(String uname){
			Cursor cursor = db.rawQuery("SELECT * FROM " + USER_TABLE + " WHERE uname=?", new String[]{uname});
			if (cursor != null){
		...
		public long addTempQuestion(String _lid, String _qitem, String _qans, String _quserans){
		...
		public Cursor getAlltempRows(){
			Cursor cr = db.query(true, TEMP_QUE_TABLE, ALL_TEMPS, null, null, null, null, null, null);
			if (cr != null) {
				cr.moveToFirst();
			}
			return cr;
		...
		public Cursor getRow(long rowId) {
			String where = TEMP_ID + "=" + rowId;
			Cursor c = 	db.query(true, TEMP_QUE_TABLE, ALL_TEMPS, 
							where, null, null, null, null, null);
			if (c != null) {
				c.moveToFirst();
			}
		...
		/*
		public int getAllrowswithA(int a){
			int sum = 0;
			Cursor cursor = db.rawQuery("SELECT sum(spoint) AS myTOTAL FROM "+ SCORE_TABLE +" WHERE rid=?",new String[]{Integer.toString(a)});
			if(cursor.moveToFirst()){
				sum = cursor.getInt(cursor.getColumnIndex("myTOTAL"));
			}
			return sum;
		}
		*/
		...
		public int getallRowswithName(String _name){
			int sum = 0;
			Cursor cursor = db.rawQuery("SELECT sum(spoint) AS myCTOTAL FROM "+ SCORE_TABLE +" WHERE score_name=?", new String[]{_name});
			if(cursor.moveToFirst()){
		...
		/*
		public int getAlltotalwithA(int b){
			int all = 0;
			Cursor cursor = db.rawQuery("SELECT sum(stotal) AS myMAX FROM "+ SCORE_TABLE +" WHERE rid=?",new String[]{Integer.toString(b)});
			if(cursor.moveToFirst()){
				all = cursor.getInt(cursor.getColumnIndex("myMAX"));
			}
			return all;
		}
		*/
