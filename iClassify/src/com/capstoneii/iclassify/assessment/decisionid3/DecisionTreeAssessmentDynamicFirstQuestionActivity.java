...
public class DecisionTreeAssessmentDynamicFirstQuestionActivity extends ActionBarActivity {
	Button checkdropbt;
	int numDragged = 0;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		animated_title.setTypewriterText("What to do this weekend based on the tree? ");
