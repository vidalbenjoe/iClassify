...
public class QuizResultAssessment extends Activity implements AnimationListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		backbutton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				/*Intent i = new Intent(QuizResultAssessment.this, LessonFlashActivity.class);
				startActivity(i);
		...
		myList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if (cursor.moveToFirst()) {
						...
						/*Bundle b = new Bundle();
						b.putInt("item", item);
						Intent intent =new Intent(getApplicationContext(), Flash1.class);
						intent.putExtras(b);
						startActivity(intent);*/
				}
				cursor.close();
