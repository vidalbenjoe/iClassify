...
public class KNNRandomQuiz extends Activity {
	...
	public void addQuestions1() {
		...
		myDb.addQuestions1(new Question(
				...
				"Workspace", "White board", "Workspace", "Canvas",
				"Property Layout")); // 4
		// 4
		myDb.addQuestions1(new Question(
				"13",
		...
		myDb.addQuestions1(new Question(
				...
				"Library Panel", "Property Panel", "Library Panel",
				"Property Panel", "Layout Panel")); // 9
		// 6
		myDb.addQuestions1(new Question("2",
				"Which of the following correct extension of flash?", ".fla",
				"-fla", "*flash", "*fla", ".fla")); // 2
		// 7
		myDb.addQuestions1(new Question("10",
				"What is the possible shortcut for Library Panel?", "CTRL+ L",
				"CTRL+ L", "Windows + D", "CTRL + ALT+ D", "SHFT + L"));// 9
		// 8
		...
		myDb.addQuestions1(new Question("12",
				...
				"Library Panel", "Memory Panel", "Library Panel",
				"Property Panel", "Control Panel"));// 10
		// 10
		myDb.addQuestions1(new Question("12",
				"Right format for importing image into Library Panel.", "JPEG",
				"JPEG", "PNG", "GIF", "BMP")); // 10
		// 11
		myDb.addQuestions1(new Question(
				"13",
		...
		myDb.addQuestions1(new Question("9",
				...
				"Property Inspector", "Library Panel", "Property Inspector",
				"Tool Panel", "Image Panel")); // 8
		// 13
		myDb.addQuestions1(new Question(
				"4",
				...
				"Adobe Professional", "Adobe Professional",
				"Adobe Flash Professional", "Flash Professional",
				"Professional")); // 3
		// 14
		myDb.addQuestions1(new Question(
				"1",
				"What is the latest version of Flash’s scripting language, which you can use to add interactivity?",
				"ActionScript 3.0", "ActionScript 1.0", "ActionScript 2.0",
				"ActionScript 3.0", "ActionScript 4.0"));// 1
		// 15
		myDb.addQuestions1(new Question(
				"13",
		...
		myDb.addQuestions1(new Question("10",
				...
				"Library Panel", "Property Panel", "Library Panel",
				"Property Pallet", "Layout Panel")); // 9
		// 21
		myDb.addQuestions1(new Question("2",
				"It is the File Extension of Flash?", ".fla", "fla", "*flash",
				"*fla", ".fla")); // 2
		// 22
		myDb.addQuestions1(new Question("10",
				"It is the shortcut key for Library Panel?", "CTRL+ L",
				"CTRL+ L", "Windows + D", "CTRL + ALT+ D", "SHFT + L"));// 9
		// 23
		myDb.addQuestions1(new Question("22",
		...
		myDb.addQuestions1(new Question(
				...
				"Property Inspector", "Property", "Library Panel",
				"Property Inspector", "Library Property")); // 10
		// 25
		myDb.addQuestions1(new Question("12",
		...
		// 27
		myDb.addQuestions1(new Question("9",
				"What panel that can set your stage?", "Property Inspector",
				"Library Panel", "Property Inspector", "Tool Panel",
				"Image Panel")); // 8
		// 28
		myDb.addQuestions1(new Question(
				"3",
				"A command menus at the top of the screen and a variety of tools and panels for editing and adding elements to your movie. ",
				"Adobe Flash Professional", "Adobe Professional",
				"Adobe Flash Professional", "Flash Professional",
				"Professional")); // 3
		// 29
		myDb.addQuestions1(new Question("1",
		...
		myDb.addQuestions1(new Question("10",
				...
				"CTRL+ L", "SHFT + L", "CTRL + ALT+ D", "Windows + D",
				"CTRL+ L")); // 9
		// 34
		myDb.addQuestions1(new Question("22",
				"A _____________ is the black dot in the timeline", "Keyframe",
				"Frame", "Keyframe", "Timeline", "Tween"));// 20
		// 35
		myDb.addQuestions1(new Question(
				"4",
				"Its automatically displays information about the currently selected sprite?",
				"Property Inspector", "Property", "Library Panel",
				"Library Property", "Property Inspector")); // 3
		// 36
		myDb.addQuestions1(new Question(
				"12",
		...
		myDb.addQuestions1(new Question(
				...
				"Adobe Flash Professional", "Adobe Professional",
				"Flash Professional", "Adobe Flash Professional",
				"Professional")); // 3
		// 40
		myDb.addQuestions1(new Question(
				"1",
				"Which of the following is the latest version of Flash’s scripting language?",
				"ActionScript 3.0", "ActionScript 4.0", "ActionScript 3.0",
				"ActionScript 2.0", "ActionScript 1.0")); // 1
		// 41
		myDb.addQuestions1(new Question(
				"10",
				"What can be found in the right Properties Inspector, that can import pictures?",
				"Library Panel", "Property Panel", "Library Panel",
				"Property Pallet", "Layout Panel")); // 2
		// 42
		myDb.addQuestions1(new Question(
				"2",
		...
		myDb.addQuestions1(new Question(
				...
				"CTRL+ L", "CTRL + ALT+ D", "Windows + D", "SHFT + L",
				"CTRL+ L")); // 9
		// 44

		myDb.addQuestions1(new Question("22",
				"It indicates a single keyframe in timeline.", "Keyframe",
				"Keyframe", "Frame", "Timeline", "Tween")); // 20
		// 45
		myDb.addQuestions1(new Question(
				"9",
				"___________ displays information about the currently selected sprite or cast member.",
				"Property Inspector", "Property", "Library Panel",
				"Library Property", "Property Inspector")); // 8
		// 46
		myDb.addQuestions1(new Question(
				"12",
				"Which of the following is the correct format for importing image into Library Panel?",
		...
		myDb.addQuestions1(new Question(
				...
				"Adobe Flash Professional", "Adobe Professional CS6",
				"Adobe Flash Professional", "Flash Professional",
				"Professional")); // 3
		// 50
		myDb.addQuestions1(new Question(
				...
				"ActionScript 3.0", "ActionScript 0.0", "ActionScript 1.0",
				"ActionScript 2.0", "ActionScript 3.0"));// 1
