...
public class PatientProbabilityComputationFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		final SecretTextView patientprobatext = (SecretTextView) rootView
				.findViewById(R.id.patientprobatext);
		...
		computationprobability = (ImageView) rootView
				.findViewById(R.id.computationprobability);
			...
			public void onClick(View InputFragmentView) {
				...
				case 1:
					computationprobability
							.setImageResource(R.drawable.probablookup2);
					computationprobability.startAnimation(animation);
				...
				case 2:
					computationprobability
							.setImageResource(R.drawable.probabcomputation);
					computationprobability.startAnimation(animation);
				...
				case 3:
					computationprobability
							.setImageResource(R.drawable.probabcomputation2);
					computationprobability.startAnimation(animation);
				...
				case 4:
					computationprobability
							.setImageResource(R.drawable.patiensolutionresults);
					computationprobability.startAnimation(animation);
				...
				case 5:
					...
					computationprobability
							.setImageResource(R.drawable.patientdividevalue);
					computationprobability.startAnimation(animation);
					break;
				case 6:
