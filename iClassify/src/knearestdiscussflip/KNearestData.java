...
public class KNearestData {
  ...
  static {
    ...
    KNearestData.IMG_DESCRIPTIONS.add(new KNearestData.Data("Step 1:  ", "knnimg4.jpg",
                                                  "<b>D = Sqrt[(48-33)^2 + (142000-150000)^2] = 8000.01  >> Default=Y</b><br>We can now use the training set to classify an unknown case (Age=48 and Loan=$142,000) using Euclidean distance. If K=1 then the nearest neighbor is the last case in the training set with Default=Y.<br>With K=3, there are two Default=Y and one Default=N out of three closest neighbors. The prediction for the unknown case is again Default=Y."
                                                 ));
